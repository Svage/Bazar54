        ...
        <div className="w-full min-h-screen flex my-[100px] mx-[30px] md:mx-[100px]">
          <div className="flex flex-col lg:flex-row gap-x-6">
            ...
            {cart.length === 0 ? (
              ...
              <div className="flex flex-col justify-around gap-y-4 md:gap-y-10 items-end">
                <div>
                ...
                <div className="flex justify-center">
                  <button className="bg-[#2a2a2a] w-[500px] text-white p-4 rounded-md cursor-pointer hover:bg-black">
                    <Link to="/explore">Выбрать товар</Link>
                  </button>
                  </div>
                </div>
              </div>
